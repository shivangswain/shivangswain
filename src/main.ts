...
app.innerHTML = `
    <div class='content'>
        <div class='main-text'>
            ...
            <p>I'm a 23 year old cybersecurity analyst working in the Technology Risk division at Goldman Sachs.</p>
            <div class='links'>
...
// Call toggleDarkMode function to enable Light/Dark mode switch
